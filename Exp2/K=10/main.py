...
# params
m = 1
phi = {0: [3.5,0.27*m,-0.54*m,0.39*m,-0.11*m,0.01*m],
       1: [3.51*m,0.43*m,-1.35*m,1.53*m,-0.73*m,0.12*m],
       2: [3.5,0.67*m,-1.72*m,1.81*m,-0.81*m,0.12*m],
       3: [3.52,0.05*m,0.0*m,-0.15*m,0.10*m,-0.02*m],
       4: [3.55,0.27*m,-0.68*m,0.55*m,-0.19*m,0.02*m],
       5: [3.49,0.16*m,0.56*m,-1.5*m,1.13*m,-0.27*m],
       #'Documentary': [3.51,1.52*m,-6.69*m,10.87*m,-7.14*m,1.55*m],
       6: [3.15,0.5,0.47,-0.93,0.47,-0.08],
       #'FilmNoir': [3.45,1.90,-6.1,8.43,-5.0,1.04],
       7: [3.54,-0.34,0.92,-1.02,0.41,-0.06],
       8: [3.5,0.64,-1.28,1.09,-0.37,0.04],
       9: [3.49,0.92,-3.24,4.49,-2.60,0.52],
       #10: [3.41,0.76,-1.5,1.26,-0.45,0.06],
       #11: [3.49,0.32,-0.66,0.55,-0.19,0.02],
       #12: [3.46,0.63,-1.45,1.38,-0.57,0.08],
       #13: [3.38,1.5,-2.76,2.31,-0.86,0.12],
       #14: [3.51,0.3,-0.48,-0.0,0.4,-0.14]
      }
arm_label = ['Thriller', 'SciFi', 'Romance', 'War', 'Drama', 'Animation', 
             'Horror', 'Action', 'Children', 'Crime']#, 'Western', 'Comedy', 'Mystery', 'Adventure', 'Musical']
